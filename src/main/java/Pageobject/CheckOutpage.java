...
public class CheckOutpage extends Utility {
	...
	public void signInAtCheckOut() {
		emailoSignInAtCheckOut.sendKeys("dummytesting23541@gmail.com");
		passToSignInAtCheckOut.sendKeys("Testing@1234567890#");
		submitSigInAtCheckOut.click();
		emailAtCheckOut.sendKeys("dummytesting23541@gmail.com");
		mobileNumAtCheckOut.sendKeys("8965847854");
		textUpdateCheckBox.click();
		continueToPayement.click();
